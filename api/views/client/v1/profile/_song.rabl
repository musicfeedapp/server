attributes :id, :name, :album, :artist, :picture, :feed_type,
  :link, :source_link,
  :youtube_link, :published_at, :font_color, :itunes_link,
  :stream, :is_liked

node(:user_facebook_id) { |timeline| locals[:publishers][timeline.id][0].author_identifier }
...
node(:likes_count) { |timeline| timeline.likes_count }
